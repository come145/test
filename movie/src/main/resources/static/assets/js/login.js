...
//            poster.setAttribute('src', crawlingData[randomNumber].jpg);
       		let imgRandom = document.getElementsByClassName("bg-illustration");
     		
     		
       		imgRandom.src = crawlingData[randomNumber].img;
			
			$('.bg-illustration').css('background', 'url(' + imgRandom.src + ')');
