...
<script type="text/javascript">
	...
	function deleteData(){
		...
		var url = "<%=cp%>/sbbs/deleted.action" + params;
	...
	function updateData(){
		...
		var pageNum = "${pageNum}";
		var params = "?boardNum=" + boardNum + "&pageNum=" + pageNum;
		var url = "<%=cp%>/sbbs/updated.action" + params;
...
<div id="bbs">
	...
	<div id="bbsArticle_footer">
			...
			<div id="rightFooter">
				<input type="button" value=" 리스트 " class="btn2" onclick="javascript:location.href='<%=cp%>/sbbs/list.action?${params }';"/>
			</div>
		</div>
	</div>
